...
// insert_or_apply is excluded under Robin Hood: same value-only-atomic-vs-displacement race as
// insert_or_assign. Re-enable (and trim slot types / probe scheme as needed) once Robin Hood
// support is generalized. See robin_hood_refactor_plan.md.
//
...
//
// template <bool HasInit, typename Map, typename Init>
// void test_insert_or_apply_shmem(Map& map, size_type num_keys, size_type num_unique_keys, Init
// init)
// {
//   REQUIRE((num_keys % num_unique_keys) == 0);
//
