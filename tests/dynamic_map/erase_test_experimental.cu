...
TEMPLATE_TEST_CASE_SIG("erase key experimental",
                       "",
                       ...
                       (int64_t, int64_t))
{
  ...
  cuco::experimental::dynamic_map<Key, Value> map{num_keys * 2,
                                                  cuco::empty_key<Key>{-1},
                                                  cuco::empty_value<Value>{-1},
                                                  cuco::erased_key<Key>{-2}};

  SECTION("Check single submap insert/erase experimental")
  {
  ...
  SECTION("Check multiple submaps insert/erase experimental")
  {
