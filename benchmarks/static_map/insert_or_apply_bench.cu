...
// This benchmark exercises insert_or_apply, an excluded op under Robin Hood: a value-only-atomic
// update races Robin Hood displacement, so it needs a whole-slot-CAS update API. No type variant
// helps. See stuff_to_raise_in_pr.md and robin_hood_refactor_plan.md.
//
