...
/**
 * @brief A benchmark evaluating `cuco::static_multiset::contains_async` performance
 */
template <typename Key, typename Dist>
void static_multiset_contains(nvbench::state& state, nvbench::type_list<Key, Dist>)
{
