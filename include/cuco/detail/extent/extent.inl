...
[[nodiscard]] auto constexpr make_bucket_extent(extent<SizeType> ext, double desired_load_factor)
{
  ...
  return make_bucket_extent<ProbingScheme, Storage>(
...
template <typename ProbingScheme, typename Storage, typename SizeType>
[[nodiscard]] auto constexpr make_bucket_extent(SizeType size, double desired_load_factor)
{
  return make_bucket_extent<ProbingScheme, Storage>(cuco::extent<SizeType>{size},
                                                    desired_load_factor);
}
